...
<head>
  ...
  <title>Sign Up - Waste2Product Admin</title>
  <!--     Fonts and icons     -->
          ...
          <div class="container-fluid ps-2 pe-0">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link me-2 active" aria-current="page" href="{{ route('admin.sign-up') }}">
        ...
        <div class="container">
          <div class="row">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('{{ asset('assets/back/img/illustrations/illustration-signup.jpg') }}'); background-size: cover;">
              </div>
            </div>
              ...
              <div class="card card-plain">
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-2 text-sm mx-auto">
                    ...
                    <a href="{{ route('admin.sign-in') }}" class="text-primary text-gradient font-weight-bold">Sign in</a>
                  </p>
                </div>
              </div>
            </div>
