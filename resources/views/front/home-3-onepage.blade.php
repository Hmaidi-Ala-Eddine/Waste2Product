...
@section('title', 'Home v3 Onepage - IT Solutions')
...
@section('content')
    ...
    <!-- Start Features -->
    <div id="services" class="features-style-two-area default-padding bottom-less bg-gray">
        <div class="container">
            <div class="row">
                        ...
                        <div class="thumb">
                            ...
                            <div class="title">
                                <div class="top">
                                    ...
                                    <h4><a href="#services">Manage it service</a></h4>
                                </div>
                                <a href="#services"><i class="fas fa-long-arrow-right"></i></a>
                            </div>
                        ...
                        <div class="thumb">
                            ...
                            <div class="title">
                                <div class="top">
                                    ...
                                    <h4><a href="#services">Cyber Security</a></h4>
                                </div>
                                <a href="#services"><i class="fas fa-long-arrow-right"></i></a>
                            </div>
                            <div class="overlay text-center">
                        ...
                        <div class="thumb">
                            ...
                            <div class="title">
                                <div class="top">
                                    ...
                                    <h4><a href="#services">Digital Experience</a></h4>
                                </div>
                                <a href="#services"><i class="fas fa-long-arrow-right"></i></a>
                            </div>
                            <div class="overlay text-center">
            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title split-text">Get in touch with us</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <button type="submit" name="submit" id="submit">
                                        ...
                                        <span class="btn-icon"><i class="fas fa-long-arrow-right"></i></span>
                                    </button>
                                </div>
                            </div>
                        </form>
